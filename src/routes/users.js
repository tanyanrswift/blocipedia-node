...
router.post("/users/upgrade", validation.validateUsers, userController.upgrade);
router.get("/users/downgrade", userController.downgradeForm);
router.post("/users/downgrade", validation.validateUsers, userController.downgrade);
